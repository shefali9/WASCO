...
@Composable
fun Registration(viewModel: RegistrationViewModel = hiltViewModel(), navController: NavController) {
    ...
    Column(
        ...
        Row(modifier = Modifier.fillMaxWidth(), verticalAlignment = Alignment.CenterVertically) {
            ...
            Text("I accept the Terms & Conditions", modifier = Modifier.weight(1f))
